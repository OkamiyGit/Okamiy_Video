package com.example.wangqing.okamiy_video.comment;
...
public class CommonDBHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "okamiy.db";
    private static final int DATABASE_VERSION = 1;
    private static final String KEY_ID = "id";//主键
    private static final String KEY_ALBUM_ID = "albumid";//数据id
    private static final String KEY_ALBUM_SITE = "albumsite";//来自于那个网站
    private static final String KEY_ALBUM_JSON = "albumjson";//json串
    private static final String KEY_CREATE_TIME = "createtime";//什么时间存
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String FAVORITE_CREATE_TABLE = "create table " + FAVORITE_TABLE_NAME + "("
                ...
                + KEY_ALBUM_JSON + " text,"
                + KEY_CREATE_TIME + " text " + ")";
        Log.i(TAG, ">>  onCreate 表  >>" + FAVORITE_CREATE_TABLE);
        Log.i(TAG, ">>  onCreate 表  >>" + HISTORY_CREATE_TABLE);
